...
//
// TypeScript runner for the lifecycle-principal-unreachable family.
//
//   npx tsx fixtures/lifecycle-principal-unreachable/verify.ts
...
const FAMILY = 'lifecycle-principal-unreachable'
