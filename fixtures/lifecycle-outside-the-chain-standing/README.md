...
Built by the lab in one session against `CASES.md` v0.2 on the local branch
`cases-v0.2` at commit `2bf5c7e` and `AUTHORITY-LIFECYCLE.md` at `7796e22` or
later. `chain.json` minted with PyPI `agent-passport-system` 4.1.0.
