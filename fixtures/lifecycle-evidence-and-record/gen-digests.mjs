...
//
// Run: node fixtures/lifecycle-evidence-and-record/gen-digests.mjs
...
const out = {
  ...
  produced_by: 'fixtures/lifecycle-evidence-and-record/gen-digests.mjs, via npm agent-passport-system canonicalizeJCS',
  inputs,
}
