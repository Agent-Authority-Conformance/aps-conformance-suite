...
//
// Run: node fixtures/lifecycle-shared-identity-with-no-accountable-principal/gen-digests.mjs
...
const out = {
  ...
  produced_by: 'fixtures/lifecycle-shared-identity-with-no-accountable-principal/gen-digests.mjs, via npm agent-passport-system canonicalizeJCS',
  inputs,
}
