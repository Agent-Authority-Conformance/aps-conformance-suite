"""Direction 1 runner: attenu-guard 0.6.1 canonicalization vs the pinned JCS bytes.

Requires: pip install attenu-guard==0.6.1. Run from this directory or the repo root.
